const partnersDark = [
  { id: 1, image: "assets/img/partners/dark/4.png", link: "" },
  { id: 2, image: "assets/img/partners/dark/2.png", link: ""  },
  { id: 3, image: "assets/img/partners/dark/3.png", link: ""  },
  { id: 4, image: "assets/img/partners/dark/1.png", link: ""  },
];
    ...
    <div className="tokyo_tm_partners w-full h-auto clear-both float-left bg-white py-[100px] px-0">
      <div className="container">
        <div className="tokyo_section_title w-full h-auto clear-both float-left mb-[40px]">
          <h3 className="text-[20px] font-bold">Agencias</h3>
          <h3 className="text-[16px] ml-[-2px]">Con las que he trabajado</h3>
        </div>
