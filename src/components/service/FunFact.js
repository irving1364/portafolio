const funFacts = [
  { id: 1, value: "30+", name: "Proyectos Culminados" },
  { id: 2, value: "20+", name: "Clientes Felices" },
  { id: 3, value: "9K+", name: "Lineas de Codigos" },
];
    ...
    <div className="tokyo_tm_facts w-full h-auto clear-both float-left px-0 pt-[100px] pb-[60px]">
      <div className="container">
        <div className="tokyo_section_title w-full h-auto clear-both float-left mb-[40px]">
          <h3 className="text-[20px] font-bold">Hitos</h3>
        </div>
